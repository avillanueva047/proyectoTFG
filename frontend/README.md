...
* Generar modulos para cada uno de los tipos de componentes (e.g. Temperatura, Persianas, Alarma, Luces, Velocidad del Viento, Oleaje, Aforo, Estado Meteorológico....)
